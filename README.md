...
**Тіло відповіді** у разі не успішного опрацювання запиту (**Code=422 - Validation error**) виглядатиме наступним чином:
...
**Тіло відповіді** у разі не успішного опрацювання запиту (**Code=400**) виглядатиме наступним чином:
...
В разі, якщо передані дані співпадають з тими, що вже є в БД, зміни внесено не буде, а в результаті виконання запиту буде передано **Code=204**.
...
**Тіло відповіді** у разі відсутності користувача з заданим unzr (**Code=404**) виглядатиме наступним чином:
```
{
"detail":"Person not found"
}
...
| **Назва параметру** | **Тип даних** |                                    **Значення параметру**                                     | **Обов’язковість** |
|:-------------------:|:-------------:|:---------------------------------------------------------------------------------------------:|:------------------:|
|        param        |    	String    | Вказується конкретний параметр, що стосується певного запису в БД, наприклад, ім’я, УНЗР тощо |        	Так         |
|        value        |    String     |                                 	Значення вказаного параметру                                 |        	Так         |

Приклад запиту:
```
http://your-server-ip:8000/person/gender/female
```
**Тіло відповіді** у разі успішного опрацювання запиту (**Code=200**) виглядатиме наступним чином:
```
{
...
| **Назва параметру** | **Тип даних** |    **Значення параметру**     | **Обов’язковість** |
|:-------------------:|:-------------:|:-----------------------------:|:------------------:|
|        param        |    	String    | начення за замовченням – unzr |        Так         |
|        value        |    String     | 	Значення вказаного параметру |        	Так         |
...
Приклад запиту:
```
http://your-server-ip:8000/person/unzr/20241011-12445
```
**Тіло відповіді** у разі успішного опрацювання запиту (**Code=200**) виглядатиме наступним чином:
```
{  
...
**Тіло відповіді** у разі відсутності запису в БД із заданим УНЗР (**Code=404**) виглядатиме наступним чином:
```
{
"detail":"Person not found"
}
...
**Тіло відповіді** у разі не успішного опрацювання запиту (**Code=422**) виглядатиме наступним чином:
```
{
